...
{
    public class HiddenLevelCoinSprite : AbstractSprite
    {

        public HiddenLevelCoinSprite(Texture2D texture, int rows, int columns, int totalFrames, int startingPointX,
            int startingPointY)
        {
            Texture = texture;
            isVisible = true;
